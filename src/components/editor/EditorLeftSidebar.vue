    ...
    >
      ...
      >
        ...
        <span
          ...
          :class="themeStore.darkMode ? 'bg-violet-400' : 'bg-violet-500'"
        />
      ...
      >
        ...
        >
          ...
          <div v-if="activeTab === 'elements' && activeCategory" class="flex items-center gap-1.5">
            ...
            <h3 class="font-semibold text-sm" :class="themeStore.darkMode ? 'text-gray-100' : 'text-gray-800'">
              {{ activeCategory.name }}
            </h3>
          </div>
          <!-- Default header -->
          <h3 v-else class="font-semibold text-sm" :class="themeStore.darkMode ? 'text-gray-100' : 'text-gray-800'">
            {{ currentTab?.label }}
          </h3>
          <button
