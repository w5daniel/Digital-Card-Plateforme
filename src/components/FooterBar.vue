      ...
      <div class="border-t border-gray-700 mt-8 pt-8">
        ...
        >
          ...
          <div class="flex items-center space-x-4">
            ...
            >
              <svg class="w-5 h-5" fill="currentColor" viewBox="0 0 24 24">
                <path d="M18.244 2.25h3.308l-7.227 8.26 8.502 11.24h-6.694l-5.259-6.877-6.027 6.877h-3.328l7.727-8.835L.742 2.25h6.892l4.807 6.355 5.537-6.355zM17.15 18.75h1.828L5.997 4.1H4.05l13.1 14.65z"/>
              </svg>
            </a>
          </div>
