    ...
    <div class="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
      <div class="flex justify-between items-center h-20">
        ...
        <div ref="navContainerRef" class="hidden md:flex items-center space-x-1 relative">
          <!-- Sliding active pill -->
          <div
            class="absolute inset-y-0 rounded-lg bg-flame-50 dark:bg-flame-950/30 transition-all duration-300 ease-out pointer-events-none"
            :style="navPillStyle"
          ></div>
          <router-link
            ...
            :class="[
              isActive(item.path)
                ? 'text-flame-600 dark:text-flame-400 nav-link-active'
                : 'text-onyx-600 dark:text-powder-400 hover:text-onyx-900 dark:hover:text-powder-200',
            ]"
          >
          ...
          <div v-if="authStore.isAuthenticated" class="relative">
            ...
            >
              ...
              <div
                ...
                :class="
                  themeStore.darkMode
                    ? 'border-onyx-800 bg-onyx-950/40'
                    : 'border-powder-100 bg-powder-50'
                "
              >
              ...
              <div class="max-h-80 overflow-y-auto">
                ...
                >
                  <Bell
                    ...
                    :class="themeStore.darkMode ? 'text-powder-400' : 'text-onyx-500'"
                  />
                  <p
                    class="text-sm"
                    :class="themeStore.darkMode ? 'text-powder-400' : 'text-onyx-500'"
                ...
                <button
                  ...
                  :class="[
                    themeStore.darkMode
                      ? 'border-onyx-800/60 hover:bg-onyx-800/50'
                      : 'border-powder-100 hover:bg-powder-50',
                ...
                >
                  ...
                  <div class="flex-1 min-w-0">
                    ...
                    <p
                      ...
                      :class="themeStore.darkMode ? 'text-powder-500' : 'text-onyx-400'"
                    >
            ...
            >
              ...
              >
                ...
                <span
                  ...
                  class="inline-block mt-1 text-xs font-medium px-2 py-0.5 rounded-full bg-flame-50 dark:bg-flame-900/30 text-flame-700 dark:text-flame-300"
                >
                  Premium
                </span>
              </div>
              ...
              <div class="py-1">
                <label
                  class="flex items-center space-x-3 px-4 py-2.5 cursor-pointer transition-colors text-sm"
                  :class="
                    themeStore.darkMode
                      ? 'text-powder-200 hover:bg-onyx-800'
      ...
      >
        ...
        >
          <div
            ...
            :class="themeStore.darkMode ? 'bg-onyx-800' : 'bg-powder-50'"
          >
            <p class="text-sm" :class="themeStore.darkMode ? 'text-powder-400' : 'text-onyx-500'">
              Connecté en tant que
            </p>
            <p class="font-semibold" :class="themeStore.darkMode ? 'text-white' : 'text-onyx-900'">
              {{ authStore.user?.name }}
            </p>
          </div>
          <router-link
