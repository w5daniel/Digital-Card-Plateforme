      ...
      <div class="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-5 gap-6 mb-12 ">
        ...
        >
          <div class="flex items-center justify-between mb-4">
            ...
            <span
              class="badge badge-ghost text-xs font-semibold"
              >Total</span
            >
          </div>
        ...
        <div v-if="dashboardTab === 'templates'" class="mb-12" key="templates">
          <div class="mb-6 flex items-center justify-between">
            ...
            <div class="flex items-center space-x-3">
              ...
              <router-link
                ...
                to="/editor"
                class="btn-secondary flex items-center space-x-2 text-sm px-4 py-2"
              >
                <Plus class="w-4 h-4" />
          ...
          >
            <div
              ...
              :key="tpl.id"
              class="card shadow hover:shadow-lg flex flex-col group"
        ...
        <div v-if="dashboardTab === 'cards'" key="cards">
          ...
          <div v-if="store.userCards.length > 0" class="grid grid-cols-1 lg:grid-cols-2 gap-8">
            <div
              ...
              :key="card.id"
              class="card shadow-lg hover:shadow-2xl group relative hover-reveal"
            >
