      ...
      <div v-if="visible" class="fixed inset-0 z-50 flex items-center justify-center p-4">
        ...
        >
          ...
          <button
            ...
            class="text-base-content/40 hover:bg-base-200 hover:text-base-content"
          >
            <X class="w-4 h-4" />
          </button>
          ...
          <div class="mb-5">
            ...
            <input
              ...
              class="bg-base-100 border-base-300 text-base-content placeholder:text-base-content/40 focus:border-primary"
          ...
          <div class="flex gap-2">
            <button
              ...
              class="bg-base-200 text-base-content/70 hover:bg-base-300"
            >
              Annuler
            </button>
            <button
